...
parser.add_argument('-zh','--zabbix_host',dest='zabbix_host',action='store',help='Zabbix Server Hostname',default='127.0.0.1')
parser.add_argument('-zp','--zabbix_port',dest='zabbix_port',action='store',help='Zabbix Server Port',default=10051)
args = parser.parse_args()

zabbix_host = args.zabbix_host #IP address of Zabbix Server
             # Zabbix Server IP
zabbix_port = args.zabbix_port             # Zabbix Server Port
